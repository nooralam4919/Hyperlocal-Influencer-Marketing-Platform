...
export declare class Presences {
     ...
     */
    list<Presence extends Models.Presence = Models.DefaultPresence>(params?: {
        queries?: string[];
        total?: boolean;
        ttl?: number;
     ...
     */
    get<Presence extends Models.Presence = Models.DefaultPresence>(params: {
        presenceId: string;
    }): Promise<Presence>;
    /**
     * Get a presence log by its unique ID. Entries whose `expiresAt` is in the past are treated as not found.
     ...
     * @returns {Promise<Presence>}
     */
    upsert<Presence extends Models.Presence = Models.DefaultPresence>(params: {
        presenceId: string;
        status: string;
        permissions?: string[];
        expiresAt?: string;
     ...
     * @returns {Promise<Presence>}
     */
    update<Presence extends Models.Presence = Models.DefaultPresence>(params: {
        presenceId: string;
        status?: string;
        expiresAt?: string;
        metadata?: object;
